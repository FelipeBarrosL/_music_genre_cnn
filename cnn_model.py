...
train_set = torchvision.datasets.ImageFolder(root='./Data/train', transform=trasnform)
train_loader = torch.utils.data.DataLoader(train_set,batch_size=batch_size, shuffle=True)

test_set = torchvision.datasets.ImageFolder(root='./Data/test', transform=trasnform)
